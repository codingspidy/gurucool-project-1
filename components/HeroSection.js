...
const HeroSection = () => {
  return (
    <div className="px-6 py-14 xl:py-0 xl:pt-8 bg-yellow/[0.15]">
      <div className="xs:w-11/12 sm:w-full max-w-7xl mx-auto xl:flex items-center space-x-6 justify-between">
        <div className="xl:py-16 text-center xl:text-left flex flex-col gap-4">
          <h2 className="text-4xl xl:text-7xl max-w-xs xl:max-w-2xl mx-auto xl:mx-0 leading-normal xl:leading-[102px] font-bold">
